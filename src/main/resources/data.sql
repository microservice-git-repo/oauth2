...
INSERT INTO USER (user_id,user_name,password,contact_number ,rating,role_role_id) VALUES (
   1, 'Sam','{bcrypt}$2y$12$swymcQT5vCm3rgmPiY5QXeyq1vRA5Za2ogpjRajcSs0E3RZ8vsB0a',43243,5,2);

INSERT INTO USER (user_id,user_name,password,contact_number ,rating,role_role_id) VALUES (
   2, 'Gaby','{bcrypt}$2y$12$swymcQT5vCm3rgmPiY5QXeyq1vRA5Za2ogpjRajcSs0E3RZ8vsB0a',43243,5,1); 
...
VALUES
	...
	1,
	'User', 
	'{bcrypt}$2y$12$swymcQT5vCm3rgmPiY5QXeyq1vRA5Za2ogpjRajcSs0E3RZ8vsB0a', 
	'foo,read,write',
